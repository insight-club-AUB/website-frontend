...
<head>
    ...
    <title>Insight Club - Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="" class="user" method = "post">
                                        ...
                                        <button name = "submit" class="btn btn-primary btn-user btn-block" onClick="clearform();">
                                            Login
                                        </button>
                                        <hr>
                                    ...
                                    <br>
                                    <div class="text-center">
                                        <a class="small" style="color:blue; font-size: 20px;" href="../index-3.html">Back to Home Page</a>
                                    </div>
                                </div>
                            </div>
                        </div>
