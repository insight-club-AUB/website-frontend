      ...
      <a
        ...
        >
          ...
          <img
            ...
            alt=""
          />
          <h2>Insight Club<span>.</span></h2>
        </a>

      <nav id="navbar" class="navbar">
        <ul>

          <li><a href="index-3.php"><span>Home</span> <i class="bi "></i></a>
           
          </li>

          <li><a class="nav-link scrollto" href="index-3.php#about">About</a></li>
          <li><a class="nav-link scrollto" href="index-3.php#services">Services</a></li>
          <li><a href="blog.php" class="active">Blog</a></li>
            
          </li>
         
          <li><a class="nav-link scrollto" href="index-3.php#contact">Contact</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle d-none"></i>
      </nav><!-- .navbar -->

      <a class="btn-getstarted scrollto" href="">Write a Blog</a>
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="mt-3">
                  ...
                  <div class="post-item">
                    ...
                    <div>
                      <h4><a href="blog-post.h">Id quia et et ut maxime similique occaecati ut</a></h4>
                      <time datetime="2020-01-01">Jan 1, 2020</time>
                    </div>
                  </div><!-- End recent post item-->
   ...
   <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                ...
                <strong>Email:</strong> Insightclubaub@gmail.com<br />
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Subscribe to our Newsletter to know us more</p>
    ...
    <div class="footer-legal text-center">
      ...
      >
        ...
        >
          <div class="copyright">
            &copy; Copyright <strong><span><u style="color: gray;">Insight Club</u></span></strong
            >. All Rights Reserved
          </div>
        </div>
        ...
        <div class="social-links order-first order-lg-last mb-3 mb-lg-0">
          ...
          <a href="https://www.facebook.com/AUBInsightClub/" class="facebook"><i class="bi bi-facebook"></i></a>
          <a href="https://www.instagram.com/insight_club_aub/" class="instagram"><i class="bi bi-instagram"></i></a>
